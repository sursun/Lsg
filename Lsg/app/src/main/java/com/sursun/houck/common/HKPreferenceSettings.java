 ...
 * @version 4.0
 */
public enum HKPreferenceSettings {
     ...
     */
    private HKPreferenceSettings(String id, Object defaultValue) {
        this.mId = id;
     ...
     */
    public static HKPreferenceSettings fromId(String id) {
        HKPreferenceSettings[] values = values();
